...
def btn_command(btn):
    ...
    #Append lettre dans la liste
    listeMot.append(btn)

    print(listeMot)
    #Affichage des lettres choisis
    labelMot = Label(testFrame, text =listeMot, bg = couleurBack, fg = couleurFg, font = "Times 30")
    labelMot.grid(row = 30, column = 1)
    return btn
...
def openGame ():
    ...
    #Thais 27.05.2021
    #Variable globale pour la liste de lettres soisis par l'utilizateur
    global listeMot
    listeMot = []
    #global gameWindow
    global testFrame
...
Dic = iFile.LireFichierCapitales("liste_des_capitales.csv")
#print(Dic)

#On prend un element de la liste pour que soit notre mot secrete!
Mot = Dic["Finlande"]
print(Mot)

main.mainloop()
#print(iFile.DicCapitales.get("Malte"))
